...
import { SitemapChapterService, LocalizedChapter, ChapterResolver } from 'kio-ng2-sitemap';
...
export declare class SidebarMenuComponent implements OnInit {
    ...
    constructor(localeService: LocaleService, sitemapChapterService: SitemapChapterService, sidebarService: SidebarService, chapterResolver: ChapterResolver, sitemapLoader: SitemapLoader);
    locale: string;
    lang: string;
